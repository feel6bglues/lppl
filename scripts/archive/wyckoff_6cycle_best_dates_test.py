...
def run_6cycle_test_multithreaded(
...
def write_outputs(output_dir: Path, results: List[Dict], analysis: Dict) -> None:
    ...
    md_lines = [
        "# 6-Cycle Wyckoff Engine Test Report (Best Dates from a438a32)",
        "",
...
def main() -> None:
    ...
    print("=" * 60)
    print("Wyckoff Engine v3.0 - 6 Cycle Test (Best Dates from a438a32)")
    print("=" * 60)
    ...
    print("\n3. 运行测试（多线程）...")
    results = run_6cycle_test_multithreaded(symbols, cycle_specs, output_dir, lookback_days=300)
