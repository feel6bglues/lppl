...
def run_10cycle_test_multiprocess(
    ...
    print("周线回看: 180周 (日历周W-FRI合成)")
    print("月线回看: 120月 (日历月ME合成)")
...
def main() -> None:
    """主函数"""
    output_dir = PROJECT_ROOT / "output" / "wyckoff_10cycle_best_config_d300_w180_m120"
    csv_path = PROJECT_ROOT / "data" / "stock_list.csv"

    print("=" * 60)
    print("Wyckoff Engine v3.0 - 10 Cycle Test (Best Config: d300_w180_m120)")
    print("=" * 60)
