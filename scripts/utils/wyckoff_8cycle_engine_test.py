...
def main() -> None:
    ...
    print("=" * 60)
    print("Wyckoff Engine v3.0 - 8 Cycle Test (ALL Stocks, 600 Days, Multi-threaded)")
    print("=" * 60)
    ...
    print("\n3. 运行测试（多线程）...")
    results = run_8cycle_test_multithreaded(symbols, cycle_specs, output_dir, lookback_days=600)
