...
from src.investment.group_rescan import HIGH_BETA_PLAN, execute_group_rescan


def main() -> None:
    parser = argparse.ArgumentParser(description="高弹性组 MA 主组合重扫")
    ...
    outputs = execute_group_rescan(HIGH_BETA_PLAN, backtest_runner)
